...
reportObject <- reproCheck(reportedValue = "53.3", obtainedValue = 53.4, valueType = 'mean')
reportObject <- reproCheck(reportedValue = "50.2", obtainedValue = 49.8, valueType = 'ci')
reportObject <- reproCheck(reportedValue = "56.4", obtainedValue = 56.9, valueType = 'ci')

#2 - t-test: t(16) = 2.06, p = .06

#3 - Targets Accuracy: 92.3 [89.8, 94.8]

reportObject <- reproCheck(reportedValue = "92.3", obtainedValue = 92.5, valueType = 'mean')
reportObject <- reproCheck(reportedValue = "89.8", obtainedValue = 90, valueType = 'ci')
reportObject <- reproCheck(reportedValue = "94.8", obtainedValue = 95.1, valueType = 'ci')
```
